document.addEventListener('DOMContentLoaded', () => {
    ...
    const slideContainer = document.getElementById('slideLogoutContainer');
    if (slideContainer && typeof BenchoUI !== 'undefined') {
        BenchoUI.createSlideToConfirm(slideContainer, {
            text: 'Desliza para cerrar sesión',
            completedText: 'Cerrando sesión...',
            onConfirm: () => {
